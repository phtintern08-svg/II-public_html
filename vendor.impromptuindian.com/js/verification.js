...
async function submitVerification() {
    ...
    try {
        ...
        const response = await ThreadlyApi.fetch('/vendor/verification/submit', {
            method: 'POST',
...
async function fetchVerificationStatus() {
    ...
    try {
        const response = await ThreadlyApi.fetch(`/vendor/verification/status/${vendorId}`);
        if (response.ok) {
...
async function fetchQuotationStatus() {
    try {
        const response = await ThreadlyApi.fetch(`/vendor/quotation/status/${vendorId}`);
        const data = await response.json();
...
async function submitQuotation() {
    ...
    try {
        ...
        const response = await ThreadlyApi.fetch('/vendor/quotation/submit', {
            method: 'POST',
            body: formData
        });
...
async function confirmUpload() {
    ...
    try {
        const response = await ThreadlyApi.fetch('/vendor/verification/upload', {
            method: 'POST',
            body: formData
        });
...
function viewDocument(docId) {
    if (!vendorId) return;
    const url = ThreadlyApi.buildUrl(`/vendor/verification/document/${vendorId}/${docId}`);
